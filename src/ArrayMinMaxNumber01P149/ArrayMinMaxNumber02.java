...
// Step 3
public class ArrayMinMaxNumber02 {
 ...
 */
/*
public class ArrayMinMaxNumber02 { // এই ক্লাসের নাম ArrayMinMaxNumber02
    public static void main(String[] args) { // এই প্রোগ্রামের প্রধান মেথড
        ...
        int minimumColumn = 0; // প্রথম কলামকে minimumColumn হিসেবে ধরছি

        // প্রথম লুপ: সারিগুলির মধ্যে ঘুরবে (3 সারি আছে)
        for (int i = 0; i < 3; i++) {
            // দ্বিতীয় লুপ: প্রতিটি সারির কলামগুলির মধ্যে ঘুরবে, কিন্তু এখানে ভুল আছে
            for (int j = 0; j < 3; j++) { // এখানে 3 হবে, না হলে লুপ সঠিকভাবে কাজ করবে না
...
int minimumColumn = 0; // প্রথম কলামকে ধরে নিচ্ছি
